...
internal val _auto_stories_outlined: ImageVector
    get() {
        if (__auto_stories_outlined != null) {
            return __auto_stories_outlined!!
        }
        __auto_stories_outlined =
            ImageVector.Builder(
                name = "auto_stories",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var __auto_stories_outlined: ImageVector? = null
