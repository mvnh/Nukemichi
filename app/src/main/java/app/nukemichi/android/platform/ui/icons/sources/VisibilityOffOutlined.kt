...
internal val _visibility_off_outlined: ImageVector
    get() {
        if (__visibility_off_outlined != null) {
            return __visibility_off_outlined!!
        }
        __visibility_off_outlined =
            ImageVector.Builder(
                name = "visibility_off",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var __visibility_off_outlined: ImageVector? = null
